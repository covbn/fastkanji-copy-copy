            ...
            <CardContent className="p-4">
              <div className="flex items-start justify-between mb-3">
                ...
                <StudySettingsSheet
                  ...
                  isPremium={isPremium}
                  onConfirm={() => {}}
                  onStartFlash={startFlashStudy}
                  onStartSRS={startSpacedRepetition}
                />
              </div>
              ...
              <div className="grid grid-cols-2 gap-2">
                <Button
                  ...
                  size="sm"
                  className="h-12 text-sm font-semibold bg-teal-500 hover:bg-teal-600 text-white shadow-md disabled:opacity-50 disabled:cursor-not-allowed rounded-xl"
                >
                ...
                <Button
                  ...
                  disabled={hasReachedLimit}
                  size="sm"
                  className="h-12 text-sm font-semibold border border-teal-400 text-teal-700 dark:text-teal-300 hover:bg-teal-50 dark:hover:bg-teal-900/50 disabled:opacity-50 disabled:cursor-not-allowed rounded-xl"
                >
