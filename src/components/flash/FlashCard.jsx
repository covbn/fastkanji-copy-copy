...
export default function FlashCard({ vocabulary, mode, onAnswer, showExampleSentences = true }) {
  ...
  return (
    <div className="w-full max-w-3xl px-2 flex items-center justify-center">
      <motion.div
        key={vocabulary.id}
          ...
          <CardContent className="p-6 md:p-10">
            <div className="space-y-6 md:space-y-8">
              ...
              <div className="text-center space-y-4">
                ...
                <motion.div
                  className="text-5xl sm:text-6xl md:text-7xl font-light text-slate-800 min-h-[80px] md:min-h-[100px] flex items-center justify-center px-2 break-all"
                ...
                {revealed ? (
                  ...
                  >
                    <div className="text-center">
                      <p className="text-3xl sm:text-4xl md:text-5xl font-normal text-teal-700 min-h-[60px] md:min-h-[70px] flex items-center justify-center px-2 break-all" style={{fontFamily: "'Crimson Pro', serif"}}>
                        {getAnswer()}
                      </p>
                    </div>

                    {/* Example - Moved to bottom, after answer */}
                    {shouldShowExample && (
                      <motion.div
                        initial={{ opacity: 0 }}
                        animate={{ opacity: 1 }}
                        className="text-xs md:text-sm text-slate-600 p-4 md:p-5 bg-stone-50 rounded-lg border border-stone-200 max-h-32 overflow-y-auto custom-scrollbar"
                      >
